...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /vagrant/operator/src/gscam)
  set(gscam_DEVEL_PREFIX /vagrant/operator/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /vagrant/operator/install)
...
if(NOT "/vagrant/operator/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2 " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/vagrant/operator/src/gscam/include;/usr/include/gstreamer-0.10;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include;/usr/include/libxml2")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/vagrant/operator/src/gscam/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /vagrant/operator/devel/lib;/opt/ros/jade/lib)
