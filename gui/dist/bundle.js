...
/***/ function(module, exports, __webpack_require__) {
	...
	const Header = __webpack_require__(95);
	const Controller = __webpack_require__(92);
	const Video = __webpack_require__(97);
	const ROS = __webpack_require__(99);

	const Application = React.createClass({ displayName: "Application",
	  render: function () {
	    return React.createElement("div", { className: "application" }, React.createElement(Header, null), React.createElement(Container, { layout: 'horizontal' }, React.createElement(Video, { ROS: ROS }), React.createElement(Controller, { ROS: ROS })));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const xbox = __webpack_require__(174);
	//console.log(xbox);
	const InlineSVG = __webpack_require__(175); // CommonJS

	const Controller = React.createClass({ displayName: "Controller",
	  getInitialState: function () {
	    return {
	      data: {},
	      control: 'visual'
	  ...
	  render: function () {
	    ...
	    if (this.state.control === 'visual') {
	      ...
	      data = React.createElement("div", { className: classNames(classes), dangerouslySetInnerHTML: { __html: xbox } });
	      //data = (<InlineSVG src={require("svg-inline!../assets/xbox.svg")} />);
	      //<img src="/src/assets/xbox-controller.svg" />);
	    } else {
	        data = React.createElement("pre", { className: "code" }, JSON.stringify(this.state.data, null, 2));
	      }
	    return React.createElement("div", { className: "controller" }, React.createElement("div", { className: "controls" }, ['visual', 'data'].map(control => {
	      const boundClick = this.changeState.bind(this, control);

	      const selected = this.state.control == control ? 'selected' : '';
	      return React.createElement("a", { onClick: boundClick, className: selected }, control);
	    })), data);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Panel = __webpack_require__(96);
	const Divider = __webpack_require__(94);
	const classNames = __webpack_require__(24);
	...
	const Container = React.createClass({ displayName: "Container",
	  ...
	  render: function () {
	    ...
	    const panels = React.Children.toArray(this.props.children).map((child, i) => {
	      ...
	      if (i === 0) {
	        return React.createElement(Panel, { key: i, className: dragged, ref: ref, styleKey: key, styleVal: val }, child);
	      } else {
	        return React.createElement(Panel, { key: i, ref: ref }, child);
	      }
	    });

	    if (panels.length > 1) {
	      let i = 1;
	      panels.splice(i, 0, React.createElement(Divider, { key: "divider", handleMouseDown: this.handleMouseDown }));
	    }
	    return React.createElement("div", { key: "controller-container", className: classes }, panels);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	let Divider = React.createClass({ displayName: "Divider",
	  render: function () {
	    return React.createElement("div", { className: "divider", onMouseDown: this.props.handleMouseDown }, React.createElement("div", { className: "thumb" }));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Header = React.createClass({ displayName: "Header",
	  render: function () {
	    return React.createElement("div", { className: "header" }, "Diamond Reef Explorers");
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Panel = React.createClass({ displayName: "Panel",
	  render: function () {
	    ...
	    return React.createElement("div", { className: classNames(classes, 'panel'), style: style }, this.props.children);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Video = React.createClass({ displayName: "Video",
	  render: function () {
	    ...
	    return React.createElement("div", { className: "video" }, React.createElement("img", { src: url, alt: "Stream" }));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(ReactDOM, React, $) {__webpack_require__(91);
	//require('./vendor/eventemitter2.min');
	//require('./vendor/roslib.min');

	const Application = __webpack_require__(90);
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(35), __webpack_require__(10), __webpack_require__(34)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*---------------------------------------------------\n    LESS Elements 0.9\n  ---------------------------------------------------\n    A set of useful LESS mixins\n    More info at: http://lesselements.com\n  ---------------------------------------------------*/\nbody {\n  font-family: \"proxima-nova\", sans-serif;\n}\nbody {\n  background: #EEE;\n}\nbody.animate {\n  -moz-transition-duration: 1s;\n  -webkit-transition-duration: 1s;\n  -o-transition-duration: 1s;\n  transition-duration: 1s;\n}\n#main {\n  height: 100%;\n}\n.application {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.light {\n  background: #EEE;\n  color: #333;\n}\n.light .panel {\n  background: #FFF;\n  border: 1px solid #CCC;\n}\n.light .divider .thumb {\n  background: #CCC;\n}\n.dark {\n  background: #000;\n  color: #FFF;\n}\n.dark .panel {\n  background: #333;\n  border: 1px solid #666;\n}\n.dark .divider .thumb {\n  background: #666;\n}\n.container {\n  display: flex;\n  flex: 1;\n  height: 100%;\n  margin: 6px;\n}\n.container.horizontal {\n  flex-direction: column;\n}\n.divider {\n  padding: 3px;\n  display: flex;\n  -ms-flex-align: center;\n  -webkit-align-items: center;\n  -webkit-box-align: center;\n  align-items: center;\n}\n.divider:hover {\n  cursor: col-resize;\n  background: linear-gradient(to bottom, rgba(207, 229, 250, 0), #cfe5fa, rgba(207, 229, 250, 0));\n}\n.divider .thumb {\n  height: 20px;\n  width: 1px;\n}\n.horizontal .divider {\n  display: flex;\n  -ms-flex-align: center;\n  -webkit-align-items: center;\n  -webkit-box-align: center;\n  align-items: center;\n}\n.horizontal .divider:hover {\n  cursor: row-resize;\n  background: linear-gradient(to right, rgba(207, 229, 250, 0), #cfe5fa, rgba(207, 229, 250, 0));\n}\n.horizontal .divider .thumb {\n  height: 1px;\n  width: 20px;\n  margin: 0 auto;\n}\n.panel {\n  -moz-transition-duration: 0s;\n  -webkit-transition-duration: 0s;\n  -o-transition-duration: 0s;\n  transition-duration: 0s;\n  flex: 1;\n  position: relative;\n  overflow: hidden;\n}\n.panel.dragged {\n  flex: none;\n}\n.code {\n  font-family: monospace;\n}\n.header {\n  padding: 6px;\n}\n.light .header {\n  background: #FFF;\n  box-shadow: 0 1px 2px rgba(0, 0, 0, 0.2);\n}\n.dark .header {\n  background: #333;\n}\n.controller {\n  position: absolute;\n  height: 100%;\n  width: 100%;\n}\n.controller .controls {\n  position: absolute;\n  top: 0;\n  right: 0;\n  border-bottom: 1px solid #CCC;\n  font-size: 10px;\n}\n.controller .controls a {\n  cursor: pointer;\n  border-left: 1px solid #CCC;\n  padding: 6px;\n  display: block;\n  float: left;\n}\n.controller .svg-container {\n  max-height: 100%;\n}\n.controller .svg-container.B circle[cx=\"467.312\"] {\n  fill: deepPink;\n}\n.controller .svg-container.A circle[cx=\"426.98\"][cy=\"236.124\"] {\n  fill: deepPink;\n}\n.controller .svg-container.X circle[cx=\"386.649\"] {\n  fill: deepPink;\n}\n.controller .svg-container.Y circle[cx=\"426.98\"][cy=\"155.462\"] {\n  fill: deepPink;\n}\n.controller .svg-container svg {\n  display: block;\n  height: 100%;\n  margin: 0 auto;\n}\n.light .controls {\n  background: #FFF;\n}\n.light .controls a:hover,\n.light .controls a.selected {\n  background: #DDD;\n}\n.dark .controls {\n  background: #333;\n}\n.dark .controls a:hover,\n.dark .controls a.selected {\n  background: #BBB;\n}\n.dark svg {\n  color: white;\n}\n.video {\n  background: black;\n  position: absolute;\n  width: 100%;\n  height: 100%;\n}\n.video img {\n  height: 100%;\n  margin: 0 auto;\n  display: block;\n}\n", ""]);
